            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.share_icon:
                        ...
                        shareIntent.putExtra(Intent.EXTRA_TEXT, "Hey, Checkout City Guide Application");
                    ...
                    case R.id.feedback_icon:
                        ...
                        mailToIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"brijeshambitious@gmail.com"});
